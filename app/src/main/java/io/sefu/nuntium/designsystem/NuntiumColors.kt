...
fun contentColorFor(backgroundColor: Color) =
    NuntiumTheme.colors.contentColorFor(backgroundColor).takeOrElse { LocalContentColor.current }

private fun NuntiumColors.contentColorFor(backgroundColor: Color): Color {
