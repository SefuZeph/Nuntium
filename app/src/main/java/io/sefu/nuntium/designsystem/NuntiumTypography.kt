...
class NuntiumTypography internal constructor(
    ...
    constructor(
        defaultFontFamily: FontFamily = SFProText,
    ...
    ): NuntiumTypography = NuntiumTypography(
        d1, d2, h1, h2, h3, h4, h5, h6, h7
    )

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is NuntiumTypography) return false
...
internal val LocalTypography = staticCompositionLocalOf { NuntiumTypography() }